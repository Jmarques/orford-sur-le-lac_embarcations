...
**Fiche d'emplacement** — La vue détaillée d'un emplacement, la même partout où on l'ouvre (grille des Structures, registre À traiter, [[Fiche d'adresse]]) : son [[Statut d'un emplacement]], sa position, son [[Membre]], et deux volets — **Observer** (consigner l'[[Occupation observée]] sur place) et **Traiter** (le journal, une [[Note (au journal)]], écrire au membre, libérer). Les gestes offerts dépendent du statut de l'emplacement, jamais de la page ; la page d'origine choisit seulement le volet montré d'abord. Un geste laisse la fiche ouverte : le statut et le journal changent sous les yeux.
